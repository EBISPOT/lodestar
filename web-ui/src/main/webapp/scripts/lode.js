...
(function($) {
    ...
    var appdetails = $("<div id='lodestar-description' class='ui-widget ui-corner-all'/>")
        .append($("<p></p>")
        .append($("<span id='app-details'>Generated by the <a href='http://ebispot.github.io/lodestar/'>LODEStar</a> linked data browser, developed by the SPOT Team, powered by <a title='Powered by Virtuoso' href='//virtuoso.openlinksw.com'> <img style='margin:auto;' src='images/powered_by-virtuoso.png' alt='Powered by Virtuoso' width='68' height='73' style='float: left; margin-bottom: 15px; border: 0px;'></a></span>")));
