...
(function($) {
    ...
    var appdetails = $("<div id='lodestar-description' class='ui-widget ui-corner-all'/>")
        .append($("<p></p>")
        .append($("<span id='app-details'>Generated by the <a href='https://github.com/EBISPOT/lodestar'>LODEStar</a> linked data browser, developed by the SPOT Team</span>")));
        ...
        if (match[1].toUpperCase() == 'CONSTRUCT' || match[1].toUpperCase() == 'DESCRIBE') {
            ...
            if (rendering.match(/HTML/)) {
                ...
                successFunc = function(json) {
                    hideBusyMessage();
                    updateHistoryTab(query, json.results.bindings.length, json.head.vars);
